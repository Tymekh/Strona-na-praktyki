...
<body>
    <div class="container">
        <div id="menu" onclick="closeMenu()">
            <div id="menu_content"">
                <div id="menu_canncel">
                    <img src="img/cancel.png" alt="cancel" class="invert" onclick="closeMenu()">
                </div>
                <div id="menu_items">
                    ...
                    <img src="img/orange_bar.png" alt="bar" id="menu_items_bar">
                    <div id="menu_social_media">
                        <a href="https://facebook.com"><img src="img/facebook_logo.png" alt="facebook_logo"></a>
                        <a href="https://twitter.com"><img src="img/twitter_logo.png" alt="twitter_logo"></a>
                        <a href="mailto:example@gmail.com"><img src="img/gmail_logo.png" alt="gmail_logo"></a>
                        <a href="https://dribbble.com"><img src="img/dribbble_logo.png" alt="dribble_logo"></a>
                        <a href="https://behance.net"><img src="img/behance_logo.png" alt="behance_logo"></a>
                    </div>
                </div>
            </div>
        </div>
